...
int main()
{
    ...
    if (!loadFromFileToMemory("D:/Projects/Project1/images/tiles.png", buffer1) ||
        !t1.loadFromMemory(buffer1.data(), buffer1.size()))
    {
        std::cerr << "Error loading tiles.png" << std::endl;
        return -1;
    }
    if (!loadFromFileToMemory("D:/Projects/Project1/images/background.png", buffer2) ||
        !t2.loadFromMemory(buffer2.data(), buffer2.size()))
    {
        std::cerr << "Error loading background.jpeg" << std::endl;
        return -1;
    }
    if (!loadFromFileToMemory("D:/Projects/Project1/images/frame.png", buffer3) ||
    ...
    if (!loadFromFileToMemory("D:/Projects/Project1/Fonts/Roboto-Black.ttf", fontBuffer))
    {
